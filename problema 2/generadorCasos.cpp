...
//que 1 este con 2 es isomorfo con que 3 este con 2, y alguno tenia que estar conectado.
			...
			// OJOOOOOO, NO VOY A HACER QUE TENGA CIERTAS CANTIDADES FIJAS DE ARISTAS ENTONCES??? TIPO VARIOS CON N-1 OTROS CON 2*N-1 OTROS CON N^2 ETC.
			// OJOOOOOO, NO VOY A HACER QUE TENGA CIERTAS CANTIDADES FIJAS DE ARISTAS ENTONCES??? TIPO VARIOS CON N-1 OTROS CON 2*N-1 OTROS CON N^2 ETC.
			// OJOOOOOO, NO VOY A HACER QUE TENGA CIERTAS CANTIDADES FIJAS DE ARISTAS ENTONCES??? TIPO VARIOS CON N-1 OTROS CON 2*N-1 OTROS CON N^2 ETC.
			// OJOOOOOO, NO VOY A HACER QUE TENGA CIERTAS CANTIDADES FIJAS DE ARISTAS ENTONCES??? TIPO VARIOS CON N-1 OTROS CON 2*N-1 OTROS CON N^2 ETC.
			// OJOOOOOO, NO VOY A HACER QUE TENGA CIERTAS CANTIDADES FIJAS DE ARISTAS ENTONCES??? TIPO VARIOS CON N-1 OTROS CON 2*N-1 OTROS CON N^2 
