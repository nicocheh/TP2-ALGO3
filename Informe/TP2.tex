...
\Large
\emph{Autores:}
Nicolás Chehebar, Matías Duran, Lucas Somacal % Your name
%\end{flushleft}
~
\end{minipage}\\[4cm]
...
\caption{ Gráfico de segundos de ejecución en función de cantidad de clientes para instancias aleatorias. \textbf CAMBIARLO POR EL NUEVO }
\end{wrapfigure}
