...
\textbf{SI ESTO NO SUCEDIO ASI EFECTIVAMENTE DE + ARISTAS + TIEMPO Y - ARISTAS - TIEMPO CAMBIARLO} Para ver esto, realizamos un gráfico de tiempo de ejecución en funcion de R y 
Efectivamente en el gráfico parecia verse una correlacion, lo que verificamos utilizando el índice de pearson, como se puede ver en la siguiente figura:
